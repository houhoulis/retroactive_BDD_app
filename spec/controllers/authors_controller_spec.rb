...
describe AuthorsController do
  ...
  describe "GET index" do
    it "assigns all authors as @authors" do
      Author.stub(:find).with(:all).and_return([mock_author])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested author as @author" do
      Author.stub(:find).with("37").and_return(mock_author)
      get :show, :id => "37"
  ...
  describe "GET new" do
    it "assigns a new author as @author" do
      Author.stub(:new).and_return(mock_author)
      get :new
      assigns[:author].should equal(mock_author)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created author as @author" do
        Author.stub(:new).with({'these' => 'params'}).and_return(mock_author(:save => true))
